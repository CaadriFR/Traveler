...
public class Main {
	...
	public static void main(String[] args) {
		...
		Population_init mypopulation = new Population_init(cities, 5);
		...
		for( int i = 0 ; i< myselection.getTabFitnessCumul().length; i++) {
			System.out.println(myselection.getTabFitnessCumul()[i] + " ");
		}
		System.out.println();
