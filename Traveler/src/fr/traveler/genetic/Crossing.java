...
public class Crossing {
    ...
    /**
     * Constructeur de la classe Crossing.
     * Crée un nouveau croisement avec deux parents donnés.
     * Initialise les enfants avec des cycles vides et la liste des cycles.
     *
     ...
     * 
     * @return Une liste de listes d'entiers représentant les cycles présents dans les parents.
     */
     ...
     * @return L'index de la ville dans le cycle du parent, ou -1 si elle n'est pas présente.
     */
    ...
    /**
     * Méthode qui construit les cycles présents dans les parents.
     * Parcourt les villes des parents pour identifier les cycles communs.
     */
     ...
     * Construit les enfants en utilisant les cycles définis dans les parents.
     * Le choix des valeurs pour les enfants est déterminé par un tirage aléatoire
     * entre les deux parents
     * Ce tirage est 0 ou 1, ce qui modélise un tirage pile ou face
     * Si on tire 0 : 
     * On met dans child1 les valeurs de parent1 imposées par le cycle.
     * On met dans child2 les valeurs de parent2 imposées par le cycle.
     * Si on tire 1:
     * On met dans child1 les valeurs de parent2 imposées par le cycle.
     * On met dans child2 les valeurs de parent1 imposées par le cycle.
     */
