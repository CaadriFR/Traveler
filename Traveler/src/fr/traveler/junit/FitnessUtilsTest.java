...
/**
 * Classe de test pour les utilitaires de fitness {@link FitnessUtils}. Elle
 * teste l'unique méthode liée au calcul de la distance minimale dans une
 * population.
 * 
 * @author Néo MORET
 */
...
public class FitnessUtilsTest {
	 ...
	 * crée une population composée de plusieurs individus avec des séquences de
	 * villes différentes.
	 */
