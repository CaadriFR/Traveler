...
public class CrossingTest {
	...
	/**
	 * Teste la méthode {@code buildCycle} pour vérifier la construction correcte
	 * des cycles entre les parents dans différents cas de figure. Ce test est très
	 * important car la fonctionnalité ou non de l'algorithme génétique repose
	 * essentiellement sur les opération de croissement
	 */
	...
	public void TestBuildCycle() {
		...
		List<List<Integer>> expected1 = new ArrayList<>(
				List.of(new ArrayList<>(List.of(0, 6, 2)), new ArrayList<>(List.of(1, 5, 3, 4))));
		...
		List<List<Integer>> expected2 = new ArrayList<>(List.of(new ArrayList<>(List.of(0)),
				new ArrayList<>(List.of(1)), new ArrayList<>(List.of(2)), new ArrayList<>(List.of(3)),
				new ArrayList<>(List.of(4)), new ArrayList<>(List.of(5)), new ArrayList<>(List.of(6)),
				new ArrayList<>(List.of(7)), new ArrayList<>(List.of(8)), new ArrayList<>(List.of(9))));
		...
		List<List<Integer>> expected3 = new ArrayList<>(List.of(new ArrayList<>(List.of(0, 2, 1, 6, 9, 8, 5)),
				new ArrayList<>(List.of(3, 7)), new ArrayList<>(List.of(4))));
